...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
   ...
   ESX.ShowNotification("Has recibido un nuevo Whatsapp de "  ..message.transmitter.. 'alert', 800)
    if Config.ShowNumberNotification == false then
     local text = (_U('new_message_from', message.transmitter))
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/878729349510099024/4R1y1RMj8TMqvUfgTIaguSPEhpAqReSlMU_pii8djEcUGydqIg5t5ohrdczRRcNfkcMc", data.field, function(data)
