...
weaponStorage = function(id)
    ...
    ESX.TriggerServerCallback('esx_casas:getInventory', function(inv)
        local elements = {}
    ...
    function(data, menu)
        if data.current.value == 's' then
            ...
            ESX.TriggerServerCallback('esx_casas:getInventory', function(inv)
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'storeItem', {
                    ...
                    TriggerServerEvent('esx_casas:storeItem', 'weapon', data2.current.weapon, data2.current.ammo, id)
                    menu2.close()
        ...
        elseif data.current.value == 'w' then
            ...
            ESX.TriggerServerCallback('esx_casas:getHouseInv', function(inv)
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'withdrawItem', {
                    ...
                    TriggerServerEvent('esx_casas:withdrawItem', 'weapon', data2.current.weapon, data2.current.ammo, id)
                    menu2.close()
                end, function(data2, menu2)
                    menu2.close()
                end)
...
moneyStorage = function(id)
    ...
    function(data, menu)
        if data.current.value == 's' then
            ESX.TriggerServerCallback('esx_casas:getInventory', function(inv)
                local elements = {}
                table.insert( elements, {label = 'Guardar Dinero negro <span style="color:red;">'..inv['money'].money..'$</span>'})
        
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'storeMoney', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('esx_casas:storeItem', 'money', data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
        ...
        elseif data.current.value == 'w' then
            ESX.TriggerServerCallback('esx_casas:server:getBlackMoney', function(inv)
                local elements = {}
                table.insert( elements, {label = 'Retirar Dinero negro <span style="color:red;">'..inv..'$</span>'})
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'withdrawItem', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('esx_casas:withdrawItem', 'money', data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'storeItem', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('esx_casas:storeItem', data2.current.type, data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
                ...
                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'withdrawItem', {
                    ...
                    ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'putAmount', {title = Strings['Amount']}, function(data3, menu3)
                        ...
                        if amount == nil then
                            ...
                            if amount >= 0 then
                                TriggerServerEvent('esx_casas:withdrawItem', 'item', data2.current.value, tonumber(data3.value), id)
                                menu3.close()
                                menu2.close()
                            else
                                ESX.ShowNotification(Strings['Invalid_Amount'])
