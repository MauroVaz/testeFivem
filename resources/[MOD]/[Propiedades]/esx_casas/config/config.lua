...
Config = {
    ...
    Furniture = { 
        ...
        ['Storage'] = {
            ...
            {'Booanonhelf', 'v_res_tre_smallbooanonhelf', 225},
    ...
    Furnituring = { -- change position of where you buy furniture here.
        ['enter'] = vector3(2748.537, 3472.652, 55.676),
        ['teleport'] = vector3(2702.157, 3451.970, 55.773),
    },
...
Strings = {
    ['Press_E'] = 'Pulsa ~y~E~s~ para %s',
    ['Furniture_Categories'] = 'Categorias',
    ['Manage_House'] = 'Administra tu casa',
    ['Buy_House'] = 'comprar la casa #%s',
    ['Knock_House'] = 'Tocar el timbre',
    ['Your_House'] = 'Tu hogar',
    ['Buyable_House'] = 'Casa en venta',
    ['Player_House'] = 'Casa del ciudadano',
    ['Storage'] = 'Acceder al armario',
    ['Sell_House'] = 'Poner en venta por $%s',
    ['Enter_House'] = 'Meter la llave y entrar',
    ['Sell_Confirm'] = 'Poner en venta por $%s?',
    ['yes'] = 'Si',
    ['no'] = 'No',
    ['Sold_House'] = 'Has vendido tu casa por $%s',
    ['Must_Sell'] = 'Solo puedes tener una casa, vende la actual para poder adquirir otra.',
    ['Buy_House_Confirm'] = 'Adquirir la casa #%s por $%s?',
    ['Manage_Door'] = 'Administrar la puerta',
    ['Accept'] = 'Abrir la puerta para que entre',
    ['Exit'] = 'Salir de casa',
    ['Noone_Home'] = 'Parece ser que no hay nadie en casa!',
    ['Someone_Knocked'] = 'Alquien a picado al timbre, ves a mir!',
    ['Let_In'] = 'Abrir la puerta',
    ['Accept_Player'] = 'Dejar entrar a %s dentro de casa?',
    ['Waiting_Owner'] = 'Espera a que el dueño te abra la puerta',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'Entrar en el Ikea',
    ['Buying_Furniture'] = '~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ Busca\n~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ cambiar categoria (%s)\n~INPUT_FRONTEND_RDOWN~ comprar %s por $%s\n~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ ~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ ajustar camara\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ rotar\n\n~INPUT_FRONTEND_RRIGHT~ salir',
    ['Confirm_Purchase'] = 'Comprar %s por $%s?',
    ['no_money'] = "No tienes tanto dinero.",
    ['Bought_Furniture'] = 'Has comprado 1x %s por $%s',
    ['Furnish'] = 'Amuebla tu hogar',
    ['Store_Garage'] = 'Pulsa ~y~E~s~ para meter el vehículo en el garaje', 
    ['Re_Furnish'] = 'Desmontar los muebles colocados',
    ['Remove'] = 'Quitar %s (#%s)',
    ['Amount'] = 'Cuantos?',
    ['Player_Inventory'] = 'Tu inventario',
    ['House_Inventory'] = 'Inventario',
    ['Invalid_Amount'] = 'No tienes tantos. coloca lo que tengas.',
    ['Store'] = 'Almacenar',
    ['Withdraw'] = 'Retirar',
    ['Storage_Title'] = 'Almacenamiento',
    ['You_Stored'] = 'Has almacenado %sx %s',
    ['You_Withdrew'] = 'Has retirado %sx %s',
    ['Not_Enough'] = 'No tienes tantos!',
    ['Not_Enough_House'] = 'No tienes tantos en el armario!',
    ['Weapons'] = 'Armas',
