...
Config.HelpTextMessage = "-1 ~INPUT_CELLPHONE_LEFT~ & ~INPUT_CELLPHONE_RIGHT~ +1 "
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_RDOWN~ Confirmar y comprar habitación por ($" .. Config.MotelPrice .. ") "
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_CANCEL~ Cancelar "
