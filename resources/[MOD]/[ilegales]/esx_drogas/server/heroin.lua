...
RegisterServerEvent('sapo_drogas:pickedUpPoppy')
AddEventHandler('sapo_drogas:pickedUpPoppy', function()
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.addInventoryItem('poppyresin', 1)
end)

RegisterServerEvent('sapo_drogas:processPoppyResin')
AddEventHandler('sapo_drogas:processPoppyResin', function()
	...
	--	print(('sapo_drogas: %s attempted to exploit heroin processing!'):format(GetPlayerIdentifiers(source)[1]))
	end
end)
