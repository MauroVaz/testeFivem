...
RegisterServerEvent('sapo_drogas:pickedUpHydrochloricAcid')
AddEventHandler('sapo_drogas:pickedUpHydrochloricAcid', function()
...
RegisterServerEvent('sapo_drogas:pickedUpSodiumHydroxide')
AddEventHandler('sapo_drogas:pickedUpSodiumHydroxide', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('sapo_drogas:pickedUpSulfuricAcid')
AddEventHandler('sapo_drogas:pickedUpSulfuricAcid', function()
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.addInventoryItem('sulfuric_acid', 1)
	
end)

RegisterServerEvent('sapo_drogas:processMeth')
AddEventHandler('sapo_drogas:processMeth', function()
	...
	--	print(('sapo_drogas: %s attempted to exploit meth processing!'):format(GetPlayerIdentifiers(source)[1]))
	end
end)
