    ...
    while true do
        ...
        elseif WarMenu.Begin('demo_menu') then
            if gangName == nil then
                ...
                local pressed, inputText = WarMenu.InputButton('Gang name: ' ..gangName, nil, _inputText)
                if pressed then
                    if inputText then
                        gangName = inputText
                    end
            ...
            if maxMembers == nil then
                ...
                local pressed, inputText = WarMenu.InputButton('Max members: ' ..maxMembers, nil, _inputText)
                if pressed then
                    if inputText then
                        local maxOnes = tonumber(inputText)
                        if maxOnes then
            ...
            if WarMenu.Button('Add rank') then
                ESX.ShowNotification('If you press Y you delete the last rank that you created.')
        ...
        elseif WarMenu.Begin('demo_style') then
            ...
            if red == nil then
                ...
                local pressed, inputText = WarMenu.InputButton('Red color: ' ..red, nil, _inputText)
                if pressed then
                    if inputText then
                        red = inputText
                    end
            ...
            if green == nil then
                ...
                local pressed, inputText = WarMenu.InputButton('Green color: ' ..green, nil, _inputText)
                if pressed then
                    if inputText then
                        green = inputText
                    end
            ...
            if blue == nil then
                ...
                local pressed, inputText = WarMenu.InputButton('Blue color: ' ..blue, nil, _inputText)
                if pressed then
                    if inputText then
                        blue = inputText
                    end
            ...
            if pressed then
                if inputText then
                    if IsModelInCdimage(inputText) then
                        ...
                        ESX.ShowNotification('Press Y to delete the last vehicle added')
                    else
