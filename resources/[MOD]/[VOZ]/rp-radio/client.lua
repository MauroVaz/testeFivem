local Radio = {
	...
	Clicanon = true, -- Radio clicanon
}
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para cerrar.~" .. radioConfig.Controls.Toggle.Name .. "~ para activar la radio.~" .. radioConfig.Controls.Decrease.Name .. "~ o ~" .. radioConfig.Controls.Increase.Name .. "~ para cambiar la frecuencia~" .. radioConfig.Controls.Input.Name .. "~ para confirmar frecuencia~" .. radioConfig.Controls.ToggleClicanon.Name .. "~ para  clicanon de radioFrecuencia: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para cerrar.~" .. radioConfig.Controls.Toggle.Name .. "~ para desactivar la radio.~" .. radioConfig.Controls.Broadcast.Name .. "~ para hablar por radio.Frecuencia: ~1~ MHz" },
	...
	while true do
		...
		if Radio.Open then
			...
			if not Radio.On then
				AddTextComponentSubstringPlayerName(Radio.Clicanon and "deshabilitar" or "habilitar")
			end
			...
			if not Radio.On then
				DisableControlAction(0, radioConfig.Controls.ToggleClicanon.Key, false)
				...
				-- Turn radio mic clicanon on/off
				if IsDisabledControlJustPressed(0, radioConfig.Controls.ToggleClicanon.Key) then
					Radio.Clicanon = not Radio.Clicanon

					SendNUIMessage({ sound = "audio_off", volume = 0.3})
					
					exports["mumble-voip"]:SetMumbleProperty("micClicanon", Radio.Clicanon)
				end
			end
		else
			s = 1000
...
AddEventHandler("onClientResourceStart", function(resName)
	...
	exports["mumble-voip"]:SetMumbleProperty("radioClickMaxChannel", radioConfig.Frequency.Max) -- Set radio clicanon enabled for all radio frequencies
