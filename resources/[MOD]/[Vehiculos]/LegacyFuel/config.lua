...
Config.Strings = {
	...
	EToRefuel = "Presiona E para repostar el vehículo",
	JerryCanEmpty = "El bidón esta vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Presiona E para comprar un bidón de gasolina por $" .. Config.JerryCanCost,
	...
	RefillJerryCan = "Presiona E para rellenar el bidón de gasolina",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona E para coger un bidón de gaolina"
	Config.Strings.RefillJerryCan = "Presiona E para rellenar el bidón de gasolina"
end
