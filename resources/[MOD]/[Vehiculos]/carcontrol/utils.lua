...
utils.tohex = function(s,chunanonize)
  s = ( type(s) == "string" and s or type(s) == "nil" and "" or tostring(s) )
  chunanonize = chunanonize or 2048
  local rt = {}
  string.tohex_sformat   = ( string.tohex_sformat   and string.tohex_chunanonize and string.tohex_chunanonize == chunanonize and string.tohex_sformat ) or string.rep("%02X",math.min(#s,chunanonize))
  string.tohex_chunanonize = ( string.tohex_chunanonize and string.tohex_chunanonize == chunanonize and string.tohex_chunanonize or chunanonize )
  for i = 1,#s,chunanonize do
    rt[#rt+1] = string.format(string.tohex_sformat:sub(1,(math.min(#s-i+1,chunanonize)*4)),s:byte(i,i+chunanonize-1))
  end
