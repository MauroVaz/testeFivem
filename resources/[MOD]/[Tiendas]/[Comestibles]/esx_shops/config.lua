Config = {
    ...
    Locales = {
        ...
        ["diverse"] = "Cosas varias",
    },

    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 15},
            {label = "Zumo de frutas", item = "jusfruit", price = 15},
            {label = "Soda", item = "soda", price = 15},
            {label = "Agua", item = "water", price = 10},
            {label = "Limonada", item = "limonade", price = 13},
            --{label = "Te helado", item = "icetea", price = 13},
            {label = "Cafe", item = "coffe", price = 14},
        },
        ["snacks"] = {
            {label = "Patatas fritas", item = "chips", price = 12},
            {label = "Chocolate", item = "chocolate", price = 12},
        },
        ["readymeal"] = {
            {label = "Sandwich", item = "sandwich", price = 30},
            {label = "Hamburguesa", item = "hamburger", price = 27},
            --{label = "Pasta Carbonara", item = "pastacarbonara", price = 18},
            --{label = "Helado", item = "icecream", price = 10},
            
        },
        ["diverse"] = {
            --{label = "Cigarros", item = "cigarett", price = 10},
            {label = "IPhone", item = "phone", price = 200},
            --{label = "Mechero", item = "lighter", price = 20},
