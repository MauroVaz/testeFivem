...
Config.market_types = {
	['247store'] = {							-- Market type ID
		...
		['market_items'] = {					-- Here you configure the items definitions
			['cerveja'] = {						-- The item ID
				['name'] = "Cerveza",				-- The item display name
