		...
		if(item.isMarket == true){
			...
			$('#nav-bar').append(`
				<li id="sidebar-1" onclick="openPage(0)">
					...
					<span class="tooltip">Tu tienda</span>
				</li>
				<li onclick="openPage(1)">
					<i class="fas fa-pallet"></i>
					<span class="tooltip">Comprar bienes</span>
				</li>
				<li onclick="openPage(2)">
					<i class="fas fa-users"></i>
					<span class="tooltip">Contratar repartidor</span>
				</li>
				<li onclick="openPage(3)">
					<i class="fas fa-chart-line"></i>
					<span class="tooltip">Actualizaciones</span>
				</li>
				<li onclick="openPage(4)">
					<i class="fas fa-cash-register"></i>
					<span class="tooltip">Cajero</span>
				</li>
				<li href="#myModal" data-toggle="modal" >
					<i class="fas fa-times"></i>
					<span class="tooltip">Vender tienda</span>
				</li>
			`);
		}
			...
			$('#job-page-list').append(`
				<li class="d-flex justify-content-between">
					...
					<div class="d-flex flex-row align-items-center">
						<button onclick="startJob('` + key + `')" class="btn btn-blue btn-darken-2 white">Iniciar trabajo</button>
					</div>
				</li>
			`);
...
function setMaxAmount(item_id,amount){
	$('#form_amount').empty();
	$('#form_amount').append(`
		<input type="number" min="1" max="` + amount + `" name="amount" class="form-control" placeholder="Cantidad de producto" required="required"> 
	`);
}
