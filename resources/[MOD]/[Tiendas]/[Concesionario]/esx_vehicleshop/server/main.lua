...
ESX.RegisterServerCallback('esx_vehicleshop:buyVehicle', function (source, cb, vehicleModel, don)
	...
	if vehicleData.category == "wabajo" or vehicleData.category == "wmedia" or vehicleData.category == "xalta" or vehicleData.category == "ysuper2" or vehicleData.category == "veventos" then
		TriggerClientEvent('notificaciones:pequeña', source, "No puedes pagar un coche vip con dinero", "error")
	else
		if don == true then
...
ESX.RegisterServerCallback('esx_vehicleshop:buyVehicleCoronas', function (source, cb, vehicleModel, don)
	local xPlayer     = ESX.GetPlayerFromId(source)
	local vehicleData = nil
	local src = source
	...
	if vehicleData.category == "muscle" or vehicleData.category == "vans" or vehicleData.category == "suvs" or vehicleData.category == "super" or vehicleData.category == "sportsclassics" or vehicleData.category == "sport" or vehicleData.category == "sedans" or vehicleData.category == "offroad" or vehicleData.category == "motorcycles" or vehicleData.category == "coupes" or vehicleData.category == "compacts" then
		TriggerClientEvent('notificaciones:pequeña', source, "No puedes pagar un coche normal con bitcoins", "error")
	else
		if don == true then
			if xPlayer.getAccounts() >= vehicleData.price * 0.8 then
				xPlayer.removeAccountMoney(account, vehicleData.price)
			...
			if xPlayer.getAccount('coronas').money >= vehicleData.price then
				xPlayer.removeAccountMoney("coronas", vehicleData.price)
				cb(true)
			else
				cb(false)
			end
...
ESX.RegisterServerCallback('esx_vehicleshop:resellVehicle', function (source, cb, plate, model)
	...
	if vehicleCategory == "wabajo" or vehicleCategory == "wmedia" or vehicleCategory == "xalta" or vehicleCategory == "ysuper2" or vehicleData.category == "veventos" then
		TriggerClientEvent('notificaciones:pequeña', source, "No puedes vender un coche VIP", "error")
		cb(false)
