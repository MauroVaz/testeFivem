...
Citizen.CreateThread(function()
	while true do
        ...
        for k in pairs(gym) do
            ...
            if dist <= 0.5 then
				DrawText3D(gym[k].x, gym[k].y, gym[k].z, 'Presiona [E] para abrir la tienda del gimnasio')
		...
		for k in pairs(arms) do
            ...
            if dist <= 0.5 then
				DrawText3D(arms[k].x, arms[k].y, arms[k].z, 'Presiona [E] para hacer brazos')
		...
		for k in pairs(chins) do
            ...
            if dist <= 0.5 then
				DrawText3D(chins[k].x, chins[k].y, chins[k].z, 'Presiona [E] para hacer abdominales')
		...
		for k in pairs(pushup) do
            ...
            if dist <= 0.5 then
				DrawText3D(pushup[k].x, pushup[k].y, pushup[k].z, 'Presiona [E] para hacer flexiones')
		...
		for k in pairs(yoga) do
            ...
            if dist <= 0.5 then
				DrawText3D(yoga[k].x, yoga[k].y, yoga[k].z, 'Presiona [E] para hacer yoga')
		...
		for k in pairs(situps) do
            ...
            if dist <= 0.5 then
				DrawText3D(situps[k].x, situps[k].y, situps[k].z, "Presiona [E] para hacer flexiones")
