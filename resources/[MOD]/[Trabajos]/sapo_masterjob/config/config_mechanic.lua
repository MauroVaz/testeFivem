...
Config.ZonesM = {
	...
	MechanicActions = {
		Pos   = { x = -197.854, y = -1317.67, z = 30.089 },
	...
	Craft = {
		Pos   = { x = -215.651, y = -1318.86, z = 29.890 },
		Size  = { x = 1.5, y = 1.5, z = 0.3 },
		Color = { r = 255, g = 0, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -184.733, y = -1288.31, z = 31.295 },
		Size  = { x = 1.5, y = 1.5, z = 0.3 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -184.733, y = -1288.31, z = 30.295 },
	...
	VehicleDelivery = {
		Pos   = { x = -182.982, y = -1320.30, z = 31.295 },
		Size  = { x = 20.0, y = 20.0, z = 0.3 },
		Color = { r = 255, g = 0, b = 0 },
		Type  = -1
	}
}
