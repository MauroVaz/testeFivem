Config.TruckPlateNumb = 0  -- Esto inicia la placa personalizada para camiones en 0
Config.MaxStops	= 10 -- Número total de paradas que una persona puede hacer antes de tener que regresar al depósito.
Config.MaxBags = 10 -- Cantidad total de bolsas que una persona puede sacar de un contenedor
Config.MinBags = 4 -- Número mínimo de bolsas que puede contener un contenedor.
Config.BagPay = 25 -- El monto pagado a cada persona por bolsa
Config.StopPay = 200 -- Pago total de la parada antes del pago de la bolsa.
Config.JobName = 'garbage'  -- No tocar
...
Config.VehicleSpawnG = {pos = vector3(-328.50,-1520.99, 27.53),}

Config.ZonesG = {
	[1] = {type = 'Zone', size = 5.0 , name = 'endmission', pos = vector3(-335.26,-1529.56, 26.58)},
	[2] = {type = 'Zone', size = 1.5 , name = 'timeclock', pos = vector3(-321.70,-1545.94, 30.02)},
