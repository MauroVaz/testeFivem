...
Config.Languages = {
  ...
  ['es'] = {
        ...
        ['camera'] = "Presione ~yw~ para usar el flash de la camara.",
        ['makeitrain'] = "Presiona ~yw~ para hacer llover.",
        ['pee'] = "Mantiene ~yw~ para mear.",
        ['spraychamp'] = "Mantiene ~yw~ rociar champán.",
        ['bound'] = "Unida ",
        ['to'] = "a",
