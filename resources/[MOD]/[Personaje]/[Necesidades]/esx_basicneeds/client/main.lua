...
RegisterNetEvent('esx_basicneeds:tacos')
AddEventHandler('esx_basicneeds:tacos', function()
	local playerPed  = PlayerPedId()
	...
	ESX.Game.SpawnObject('prop_taco_01', {
		x = coords.x,
		y = coords.y,
		z = coords.z - 3
	}, function(object)
...
AddEventHandler('esx_basicneeds:chocolate', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
...
RegisterNetEvent('esx_basicneeds:completo')
AddEventHandler('esx_basicneeds:completo', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
...
RegisterNetEvent('esx_basicneeds:nuggets')
AddEventHandler('esx_basicneeds:nuggets', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
	...
	ESX.Game.SpawnObject('prop_bar_nuts', {
		x = coords.x,
		y = coords.y,
		z = coords.z - 3
	}, function(object)
...
RegisterNetEvent('esx_basicneeds:doritos')
AddEventHandler('esx_basicneeds:doritos', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'v_ret_ml_chips3'
		IsAnimated = true
	...
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			ESX.Streaming.RequestAnimDict('mp_player_intdrink', function()
				...
				SetPedIsDrug(PlayerPedId(), false)
...
RegisterNetEvent('esx_basicneeds:red')
AddEventHandler('esx_basicneeds:red', function(prop_name)
	if not IsAnimated then
...
AddEventHandler('esx_basicneeds:cafe', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('esx_basicneeds:jugo')
AddEventHandler('esx_basicneeds:jugo', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
...
RegisterNetEvent('esx_basicneeds:dona')
AddEventHandler('esx_basicneeds:dona', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
	...
	ESX.Game.SpawnObject('prop_donut_01', {
		x = coords.x,
		y = coords.y,
		z = coords.z - 3
	}, function(object)
...
RegisterNetEvent('esx_basicneeds:papas')
AddEventHandler('esx_basicneeds:papas', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_food_chips'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:cereales')
AddEventHandler('esx_basicneeds:cereales', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
	...
	ESX.Game.SpawnObject('v_ret_247_cereal1', {
		x = coords.x,
		y = coords.y,
		z = coords.z - 3
	}, function(object)
...
RegisterNetEvent('esx_basicneeds:pizza')
AddEventHandler('esx_basicneeds:pizza', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('esx_basicneeds:pollo')
AddEventHandler('esx_basicneeds:pollo', function()
	local playerPed  = PlayerPedId()
	local coords     = GetEntityCoords(playerPed)
	local boneIndex  = GetPedBoneIndex(playerPed, 18905)
	local boneIndex2 = GetPedBoneIndex(playerPed, 57005)
	...
	ESX.Game.SpawnObject('prop_turkey_leg_01', {
		x = coords.x,
		y = coords.y,
		z = coords.z - 3
	}, function(object)
