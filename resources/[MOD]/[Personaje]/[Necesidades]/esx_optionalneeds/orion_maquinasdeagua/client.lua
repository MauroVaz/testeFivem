...
ESX.ShowFloatingHelpNotification('Pulsa  ~INPUT_PICKUP~para beber agua', vector3(playerX, playerY, playerZ))
                    if IsControlJustReleased(0, 38) then
                        ...
                        if not IsAnimated then
                            ...
                            TriggerServerEvent('orion_maquinasdeagua:refillThirst')
