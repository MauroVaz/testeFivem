...
function CreateDataStore(name, owner, data)
	...
	self.save = function()
		for i=1, #timeoutCallbacanon, 1 do
			ESX.ClearTimeout(timeoutCallbacanon[i])
			timeoutCallbacanon[i] = nil
		end
		...
		table.insert(timeoutCallbacanon, timeoutCallback)
	end
