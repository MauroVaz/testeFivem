...
Config.Language = {
	joining = "[FURY PVP] Entrando...",
	connecting = "[FURY PVP] Conectando...",
	err = "[FURY PVP] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[FURY PVP] Você foi desconectado por demorar demais na fila.",
	pos = "Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[FURY PVP] Não foi possível adiciona-lo na fila.",
    wlonly = "[FURY PVP] Você não está aprovado na whitelist.",
	banned = "[FURY PVP] Seu passaporte foi revogado na cidade.",
	steam = "[FURY PVP] Você precisa estar com a Steam aberta para conectar."
}
